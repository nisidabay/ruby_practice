...
# each_with_index method in Ruby is similar to `each`, but it provides access
# to both the element and its index within the enumerable object. It returns an
...
[1, 2, 3, 4, 5].each_with_index { |value, index| puts "value #{value} at index #{index} is odd" if value.odd? }
